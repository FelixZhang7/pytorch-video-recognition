...
def download_url(url, model_dir="~/code/pva/video/backbones/proxyless_nas", overwrite=False):
...
def load_url(url, model_dir='~/code/pva/video/backbones/proxyless_nas', map_location=None):
