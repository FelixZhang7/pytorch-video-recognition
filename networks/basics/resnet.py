...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet50c',
           'resnet50d', 'resnet101', 'resnet152']

model_zoo_path = '/mnt/lustre/share/spring/model_zoo'

model_paths = {
    'resnet18': 'res18_batch2k_epoch100_colorjitter_0.2_0.2_0.2_0.1_nesterov',
    'resnet34': 'res34_batch2k_epoch100_colorjitter_0.2_0.2_0.2_0.1_nesterov',
...
def resnet50(pretrained=False, **kwargs):
    ...
    # print(model.conv1.weight[1, 1])
    # print("pretrained,", _pretrained['state_dict']['module.conv1.weight'][1, 1])
    return model
